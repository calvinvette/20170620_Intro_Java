...
public class OrdersEndpoint {
	...
	public Response create(Orders entity) {
		...
		return Response.created(
				UriBuilder.fromResource(OrdersEndpoint.class)
						.path(String.valueOf(entity.getOrderId())).build())
				.build();
	}
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Orders> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT o FROM Orders o WHERE o.orderId = :entityId ORDER BY o.orderId",
						Orders.class);
	...
	@GET
	@Produces("application/json")
	public List<Orders> listAll(@QueryParam("start") Integer startPosition,
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") Long id, Orders entity) {
		if (entity == null) {
