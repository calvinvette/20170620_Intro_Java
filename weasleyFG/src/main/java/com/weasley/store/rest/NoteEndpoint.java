...
public class NoteEndpoint {
	...
	public Response create(Note entity) {
		...
		return Response.created(
				UriBuilder.fromResource(NoteEndpoint.class)
						.path(String.valueOf(entity.getNoteId())).build())
				.build();
	}
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Note> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT n FROM Note n WHERE n.noteId = :entityId ORDER BY n.noteId",
						Note.class);
	...
	@GET
	@Produces("application/json")
	public List<Note> listAll(@QueryParam("start") Integer startPosition,
		...
		final List<Note> results = findAllQuery.getResultList();
		return results;
	}
